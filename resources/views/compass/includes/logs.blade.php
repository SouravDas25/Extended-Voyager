<div class="col-sm-3 col-md-3 sidebar">
    <h3><i class="voyager-logbook"></i> {{ __('voyager::compass.logs.title') }}
        <small>{{ __('voyager::compass.logs.text') }}.</small>
    </h3>
...
<div class="col-sm-9 col-md-9 table-container table-responsive">
    @if ($logs === null)
        <div>
    ...
    <div>
        @if($current_file)
            <a href="?download={{ base64_encode($current_file) }}"><span
            ...
            @if(count($files) > 1)
                ...
                <a id="delete-all-log" href="?delall=true"><span
                            class="glyphicon glyphicon-trash"></span> {{ __('voyager::compass.logs.delete_all_files') }}
                </a>
            @endif
        @endif
    </div>
