<nav class="navbar fixed-top navbar-toggleable-md navbar-expand-lg scrolling-navbar double-nav">
    ...
    <ul class="nav navbar-nav nav-flex-icons ml-auto  @if (config('voyager.multilingual.rtl')) navbar-left @else navbar-right @endif">
        <li class="nav-item dropdown notifications-nav">
            ...
            <div class="dropdown-menu dropdown-info dropdown-menu-right p-2"
                 aria-labelledby="navbarDropdownMenuLink" style="min-width:250%">
        ...
        <li class="dropdown nav-item" style="border: 0">
            <a href="#" class="nav-link dropdown-toggle text-right  waves-effect" data-toggle="dropdown"
               role="button"
               aria-expanded="false">
