...
<p align="center">
<a href="https://travis-ci.org/SouravDas25/voyager"><img src="https://travis-ci.org/SouravDas25/voyager.svg?branch=master" alt="Build Status"></a>
...
```bash
composer require sd25/extended-voyager
```
